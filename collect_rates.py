...
# 항목 코드는 2026-08 probe 실측으로 확정한 값이다 (실행 로그에 전체 목록 있음).
# 처음 짐작으로 넣은 코드는 loan이 "소액대출(500만원 이하)", deposit이 저축성수신
# 총괄을 가리켰다. 화면 라벨과 다른 지표가 나가기 직전에 로그의 통계명 검증으로 잡았다.
SERIES = [
    ("base", "722Y001", "0101000", "한국은행 기준금리"),
    ("deposit", "121Y002", "BEABAA2118", "예금은행 정기예금 1년 (신규취급액)"),
    ("loan", "121Y006", "BECBLA03041", "예금은행 전세자금대출 (신규취급액)"),
]
